...
def load_models():
    ...
    loaded_trained_model_xgb.load_model("price_estimate/output/saved_models/trained_model_xgb.model")
    loaded_trained_model_lgb = lgb.Booster(model_file="price_estimate/output/saved_models/trained_model_lgb.txt")
    import joblib
    trained_base_models_ = joblib.load("price_estimate/output/saved_models/trained_base_models_.pkl")
    trained_meta_model_ = joblib.load("price_estimate/output/saved_models/trained_meta_model_.pkl")
...
def run_predict_models(trained_stacked_averaged_models, trained_model_xgb, trained_model_lgb, test):
